...
class SearchPhotosByTagTest {
    ...
    fun testSearchPhotosSuccess() = runTest {
        ...
        coEvery { repository.searchPhotos("cats", "any", 20, 1) } returns Result.success(photosResponse)
    ...
    fun testSearchPhotosFailure() = runTest {
        ...
        coEvery { repository.searchPhotos("dogs", "any", 20, 1) } returns Result.failure(exception)
